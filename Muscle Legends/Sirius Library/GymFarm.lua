return function(Env)
    ...
    GymTab:CreateSection("")

    GymTab:CreateLabel("Auto Gym Category", "dumbbell")

    GymTab:CreateSection("Lifting")
    ...
    -- =============================================================================
    -- КООРДИНАТЫ ТРЕНАЖЁРОВ (оставлены без изменений, слишком много кода)
    -- =============================================================================
    ...
    -- LIFTING TAB
    -- =============================================================================
    LiftingTab:CreateSection("")

    LiftingTab:CreateLabel("Auto Lift Category", "brain")
    ...
    wait(0.5)
    print("Cloud Oxygen Hub: Loaded GymFarm.lua successfully!")
end
